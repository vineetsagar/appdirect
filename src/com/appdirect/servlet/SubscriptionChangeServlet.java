...
/**
 * Servlet implementation class SubscriptionChangeServlet
 */
public class SubscriptionChangeServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public SubscriptionChangeServlet() {
        super();
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
    	...
    	JSONResponse jsonResponse = impl.handle(RequestType.CHANGE , request.getParameterMap());
